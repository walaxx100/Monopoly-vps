...
const BOARD = [
  ...
  { id: 50, name: "Treasure", type: "treasure" },
  
  // Top row (ids 24-36): 13 casillas
  { id: 36, name: "Go to Prison", type: "go_to_jail" },
  { id: 38, name: "Tokyo", type: "property", price: 280, rent: [24,120,200,500,700,900], color: "blue", flag: "🇯🇵" },
  ...
  { id: 35, name: "Paris", type: "property", price: 260, rent: [22,110,190,480,680,870], color: "blue", flag: "🇫🇷" },
  { id: 34, name: "Toulouse", type: "property", price: 260, rent: [22,110,190,480,680,870], color: "blue", flag: "🇫🇷" },
